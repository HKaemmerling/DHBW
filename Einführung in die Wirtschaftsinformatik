# Einführung in die Wirtschaftsinformatik (27.10.2016)
* interdisziplinäres Fach

## Organisation:
* gemeinsames Ziel aller Angestellten ("Zweckgemeinschaft")
* Ökosystem
* Menschen, die effizient arbeiten
* Ziel: Mehrwert für Individuum/Gruppe erzeugen (Produkte/Dienstleistungen)
...
## Stakeholder:
* Interessent an einer Sache (Aktionär, Betriebsrat, Angestellter, Manager, ...)
* alle, die ein Interesse an der Sache haben
* Bsp.: bei neuer Filiale, für die Wald abgeholzt werden muss, ist z.B. Greenpeace ein Stakeholder

## Einflussfaktoren:
* Gesellschaft + Werte beeinflussen Unternehmung
* Politik (Vorgaben, Gesetze, Auflagen, Regierung (Legislative))
* Krieg / Bürgerkrieg
* Soziale Faktoren
* Umwelteinflüsse (man selbst + ander) (ökologisch)
...
### 3. Sozial / politisch / rechtlich:
* Corporate Social Responsibility
* Regierungsvorgaben
* Terrorattacken
* Ethik (ethisches Verhalten)
...
1.
  * strategisch ausgerichtetes Informationssystem
      * --> Vorsprung
      * --> competetive advantage (Wettbewerbsvorteil)
2.
  * Kunden verstehen (Kundenbedürfnisse)
  * das, was der Kunde braucht anbieten
  * produzieren, wenn Auftrag da ist
3.
  * auf 1 Kunden angepasstes Produkt in Masse produzieren (spezifisch in Masse)
    * --> günstiger
    * --> einfacher
    * --> schneller
